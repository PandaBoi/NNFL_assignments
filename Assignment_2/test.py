...
#lambdA = 0.0002,sizes = [40,30,20],alpha = 0.01,pre_ep = 100,epochs = 100,thresh = 1e-8
class AutoEncoder():

	def __init__(self,inp_feat = 73,out_feat = 1,lambdA = 0.0002,sizes = [40,30,20],alpha = 0.01,pre_ep = 100,epochs = 1000,thresh = 1e-8):
